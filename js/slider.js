    ...
    Slider.prototype = {
        ...
        imgload: function(index){
            ...
            if(_this.item.length > 0){
                var imgs = _this.item.find('img');
                $.each(imgs,function(i){
                    if(imgs[i].getAttribute('gome-src')){
                        imgs[i].setAttribute('src', imgs[i].getAttribute('gome-src'));
                        imgs[i].removeAttribute('gome-src');
                    }
                })

                /*for(var i = 0, len = _this.item.length; i < len; i++){

                    if(imgs.getAttribute('gome-src')){
                        imgs.setAttribute('src', imgs[i].getAttribute('gome-src'));
                        imgs.removeAttribute('gome-src');
                    }
                    ;
                }*/
                ;
